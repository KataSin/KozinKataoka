...
void NumberTexture::draw(const Vector2 & position, int num, Vector4 color, float scale) const
{
	draw(position, std::to_string(num), color,scale);
}

void NumberTexture::draw(const Vector2 & position, const std::string & num, Vector4 color, float scale) const
{
