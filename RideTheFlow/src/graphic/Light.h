...
public:
	...
	/// ライトのディフューズカラーを設定する
	///</summary>
	void SetDiffuseColor(const std::string& handlename, Vector4& color);

	///<summary>
	/// ライトのスペキュラーカラーを設定する
	///</summary>
	void SetSpecularColor(const std::string& handlename, Vector4& color);

	///<summary>
	/// ライトのアンビエントカラーを設定する
	///</summary>
	void SetAmbientColor(const std::string& handlename, Vector4& color);

	///<summary>
	/// ライトのディフューズカラーを受け取る
	///</summary>
	Vector4 GetDiffuseColor(const std::string& handlename);

	///<summary>
	/// ライトのスペキュラーカラーを受け取る
	///</summary>
	Vector4 GetSpecularColor(const std::string& handlename);

	///<summary>
	/// ライトのアンビエントカラーを受け取る
	///</summary>
	Vector4 GetAmbientColor(const std::string& handlename);
